...
public class Loader3 {
    ...
    public static void main(String[] args) throws GitAPIException, IOException {
        ...
        System.out.println(repository.getLocalUrl() == null ? "Repositorio recuperado a partir da url remota" : repository.getLocalUrl());
        System.out.println(repository.getRemoteURL() == null ? "Repositorio recuperado a partir da url local" : repository.getRemoteURL());
