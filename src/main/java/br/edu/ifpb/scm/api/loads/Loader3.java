...
//
//import br.edu.ifpb.scm.api.GitBuilder;
...
//        Builder builder = new GitBuilder();
//        //Repository repository = builder.url(URL).dir(PATH3.getCanonicalPath()).create(ScmType.GIT).buildClone();
//        Repository repository = builder.url(URL).dir("C:/Users/Anderson Sousa/Desktop/gpes/clone-example").create(ScmType.GIT).build();
//        print(repository);
//    }
//
